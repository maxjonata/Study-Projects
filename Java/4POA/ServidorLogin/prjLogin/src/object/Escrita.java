...
public class Escrita {
	...
	public void insere(String login) throws IOException, WriteException {
	...
	private void defineConteudo(WritableSheet sheet) throws WriteException,
		...
		// Primeira coluna
		addLabel(sheet, 0, 1, "Catarina e Ruan");
		// Segunda coluna
		addLabel(sheet, 1, 1, "Lucas e Raquel");
		// Terceira coluna
		addNumero(sheet, 2, 1, 3000);

		addLabel(sheet, 0, 2, "Jonatha");
		// Segunda coluna
		addLabel(sheet, 1, 2, "Manuella");
		// Terceira coluna
	...
	public static void excel(String login) {
		// WritableWorkbook workbookIn;
		Escrita exemplo = new Escrita();
		try {
			exemplo.insere(login);
